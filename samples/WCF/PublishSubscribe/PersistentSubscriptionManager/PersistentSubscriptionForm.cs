...
namespace PersistentSubscriptionManager
{
   public partial class ManagerForm : Form
   {
      ...
      {
         string[] contracts = MetadataHelper.GetContracts(m_MEXAddressTextBox.Text);
      ...
      void OnContractChanged(object sender,EventArgs e)
      {
         ...
         m_ServiceAddress.Text = MetadataHelper.GetAddresses(m_MEXAddressTextBox.Text,m_ContractNamespace,m_ContractName)[0];
      }
      ...
      {
         m_Proxy.PersistSubscribe(m_ServiceAddress.Text,m_ContractComboBox.Text,m_EventTypeComboBox.Text);
         RefreshGrid();
      }
