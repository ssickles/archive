...
namespace TodoList.WpfClient.ServiceReference1 {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://wcfclientguidance.codeplex.com/2009/04", ConfigurationName="ServiceReference1.ITodoListService", CallbackContract=typeof(TodoList.WpfClient.ServiceReference1.ITodoListServiceCallback))]
    public interface ITodoListService {
        
        [System.ServiceModel.OperationContractAttribute(Action="http://wcfclientguidance.codeplex.com/2009/04/ISubscriber/Subscribe", ReplyAction="http://wcfclientguidance.codeplex.com/2009/04/ISubscriber/SubscribeResponse")]
        void Subscribe();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://wcfclientguidance.codeplex.com/2009/04/ISubscriber/Unsubscribe", ReplyAction="http://wcfclientguidance.codeplex.com/2009/04/ISubscriber/UnsubscribeResponse")]
        void Unsubscribe();
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public interface ITodoListServiceCallback {
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://wcfclientguidance.codeplex.com/2009/04/ITodoListService/ItemAdded")]
        void ItemAdded(TodoList.WpfClient.ServiceReference1.TodoItem item);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://wcfclientguidance.codeplex.com/2009/04/ITodoListService/ItemChanged")]
        void ItemChanged(TodoList.WpfClient.ServiceReference1.TodoItem item);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://wcfclientguidance.codeplex.com/2009/04/ITodoListService/ItemDeleted")]
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public partial class TodoListServiceClient : System.ServiceModel.DuplexClientBase<TodoList.WpfClient.ServiceReference1.ITodoListService>, TodoList.WpfClient.ServiceReference1.ITodoListService {
        
        public TodoListServiceClient(System.ServiceModel.InstanceContext callbackInstance) : 
                base(callbackInstance) {
        }
        
        public TodoListServiceClient(System.ServiceModel.InstanceContext callbackInstance, string endpointConfigurationName) : 
                base(callbackInstance, endpointConfigurationName) {
        }
        
        public TodoListServiceClient(System.ServiceModel.InstanceContext callbackInstance, string endpointConfigurationName, string remoteAddress) : 
                base(callbackInstance, endpointConfigurationName, remoteAddress) {
        }
        
        public TodoListServiceClient(System.ServiceModel.InstanceContext callbackInstance, string endpointConfigurationName, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(callbackInstance, endpointConfigurationName, remoteAddress) {
        }
        
        public TodoListServiceClient(System.ServiceModel.InstanceContext callbackInstance, System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
    ...
    public class TodoListServiceDuplexProxy<C> : ExceptionHandlingDuplexProxyBase<ITodoListService, C>, ITodoListService
        where C :  class {
        
        public TodoListServiceDuplexProxy() {
        }
        
        public TodoListServiceDuplexProxy(C callbackObject, string endpointConfigurationName) : 
                base(callbackObject, endpointConfigurationName) {
        }
        
        public TodoListServiceDuplexProxy(C callbackObject, string endpointConfigurationName, string remoteAddress) : 
                base(callbackObject, endpointConfigurationName, remoteAddress) {
        }
        
        public TodoListServiceDuplexProxy(C callbackObject, System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(callbackObject, binding, remoteAddress) {
        }
        
        public void Subscribe() {
            base.Invoke("Subscribe");
        }
        
        public void Unsubscribe() {
            base.Invoke("Unsubscribe");
        }
