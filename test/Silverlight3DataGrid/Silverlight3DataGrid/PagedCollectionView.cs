...
namespace Silverlight3DataGrid
{
    public sealed class PagedCollectionView : ICollectionView, IEnumerable, INotifyCollectionChanged, IPagedCollectionView, IEditableCollectionView, INotifyPropertyChanged
    {
        ...
        private void OnNotifyCollectionChanged(object sender, NotifyCollectionChangedEventArgs args)
        {
        ...
        public object AddNew()
        {
            ...
            if (index > -1)
            {
                ...
                this.OnCollectionChanged(new NotifyCollectionChangedEventArgs(1, itemAt, index));
            }
            ...
            this.OnCollectionChanged(new NotifyCollectionChangedEventArgs(0, obj2, count));
        ...
        public void CancelNew()
        {
            ...
            if (this.CurrentAddItem != null)
            {
                ...
                if (this.CurrentAddItem != null)
                {
                    ...
                    this.OnCollectionChanged(new NotifyCollectionChangedEventArgs(1, obj2, index));
                    this.RaiseCurrencyChanges(false, currentItem, currentPosition, isCurrentBeforeFirst, isCurrentAfterLast);
                    if (num2 > -1)
                    {
                        ...
                        this.OnCollectionChanged(new NotifyCollectionChangedEventArgs(0, item, this.IndexOf(item)));
                    }
                }
            }
        }
        ...
        public void CommitEdit()
        {
            ...
            if (this.CurrentEditItem != null)
            {
                ...
                if (this.UsesLocalArray)
                {
                    ...
                    {
                        this.AdjustCurrencyForRemove(index);
                        this.OnCollectionChanged(new NotifyCollectionChangedEventArgs(1, currentEditItem, index));
                    }
                    ...
                    else
                    {
                        ...
                        if (this.IsGrouping)
                        {
                            ...
                            if (flag3 && ((this.PageSize == 0) || ((num4 <= num6) && (num5 > num6))))
                            {
                                ...
                                this.OnCollectionChanged(new NotifyCollectionChangedEventArgs(0, currentEditItem, num7));
                            }
                            else if (this.PageSize > 0)
                            {
                                ...
                                if (item != null)
                                {
                                    ...
                                    this.OnCollectionChanged(new NotifyCollectionChangedEventArgs(0, item, num8));
                                }
                            }
                        }
                        else
                        {
                            ...
                            if (num9 >= 0)
                            {
                                ...
                                this.OnCollectionChanged(new NotifyCollectionChangedEventArgs(0, currentEditItem, num9));
                            }
                            else if (this.PageSize > 0)
                            {
                                ...
                                {
                                    this.AdjustCurrencyForEdit(newCurrentItem, num9);
                                    this.OnCollectionChanged(new NotifyCollectionChangedEventArgs(0, this.GetItemAt(num9), num9));
                                }
                            }
                        }
                ...
                if (this.UsesLocalArray)
                {
                    ...
                    if (this.IsGrouping)
                    {
                        ...
                        if (flag3 && ((this.PageSize == 0) || ((num4 <= num6) && (num5 > num6))))
                        {
                            ...
                            this.OnCollectionChanged(new NotifyCollectionChangedEventArgs(0, obj2, num7));
                        }
                    ...
                    else
                    {
                        ...
                        if (num9 >= 0)
                        {
                            ...
                            this.OnCollectionChanged(new NotifyCollectionChangedEventArgs(0, obj2, num9));
                        }
                        else if (!flag3 && ((this.PageSize == 0) || this.OnLastLocalPage))
                        {
                            this.AdjustCurrencyForRemove(index);
        ...
        private void ProcessAddEvent(object addedItem, int addIndex)
        {
            ...
            if ((((this.PageSize > 0) && !this.OnLastLocalPage) && ((this.IsGrouping && (item != null)) || (!this.IsGrouping && (((this.PageIndex + 1) * this.PageSize) > this.InternalIndexOf(addedItem))))) && ((item != null) && (item != addedItem)))
            {
                ...
                this.OnCollectionChanged(new NotifyCollectionChangedEventArgs(1, item, this.PageSize - 1));
            }
            if (flag)
            {
            ...
            if (index >= 0)
            {
                ...
                this.OnCollectionChanged(new NotifyCollectionChangedEventArgs(0, addedItem, index));
                this.RaiseCurrencyChanges(false, currentItem, currentPosition, isCurrentBeforeFirst, isCurrentAfterLast);
            }
            else if (this.PageSize > 0)
            {
                ...
                {
                    this.OnCollectionChanged(new NotifyCollectionChangedEventArgs(0, this.GetItemAt(0), 0));
                }
            }
        }
        ...
        private void ProcessRemoveEvent(object removedItem, bool isReplace)
        {
            ...
            if (flag)
            {
                ...
                bool isCurrentBeforeFirst = this.IsCurrentBeforeFirst;
                this.AdjustCurrencyForRemove(index);
                this.OnCollectionChanged(new NotifyCollectionChangedEventArgs(1, removedItem, Math.Max(0, index)));
                this.RaiseCurrencyChanges(false, currentItem, currentPosition, isCurrentBeforeFirst, isCurrentAfterLast);
                ...
                else if ((this.PageSize > 0) && (this.Count == this.PageSize))
                {
                    ...
                    this.OnCollectionChanged(new NotifyCollectionChangedEventArgs(0, this.GetItemAt(this.PageSize - 1), this.PageSize - 1));
                }
            }
        }
        ...
        private void SetSortDescriptions(SortDescriptionCollection descriptions)
        {
            ...
            {
                this._sortDescriptions.remove_CollectionChanged(new NotifyCollectionChangedEventHandler(this, (IntPtr)this.SortDescriptionsChanged));
            }
            this._sortDescriptions = descriptions;
            if (this._sortDescriptions != null)
            {
                this._sortDescriptions.add_CollectionChanged(new NotifyCollectionChangedEventHandler(this, (IntPtr)this.SortDescriptionsChanged));
            }
        }
        ...
        private List<object> SortList(List<object> list)
        {
            ...
            foreach (SortDescription description in this.SortDescriptions)
            {
                ...
                string propertyPath = description.get_PropertyName();
                ...
                switch (description.get_Direction())
                {
        ...
        internal class SortFieldComparer : IComparer
        {
            ...
            private static SortPropertyInfo[] CreatePropertyInfo(SortDescriptionCollection sortFields)
            {
                ...
                {
                    infoArray[i].PropertyPath = sortFields[i].get_PropertyName();
                    SortDescription description2 = sortFields[i];
                    infoArray[i].Descending = description2.get_Direction() == ListSortDirection.Descending;
                }
                return infoArray;
            }
